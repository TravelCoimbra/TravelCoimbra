...
<body>
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div>
        						...
        						if (isset($_SESSION['user_nonexistent']))
                    {
        							...
        							unset($_SESSION["user_nonexistent"]);
        						}
                    if (isset($_SESSION['wrong_password']))
                    {
        							echo '<p style="color:#900">Wrong password!</p>';
        							unset($_SESSION["wrong_password"]);
        						}
        						?>
                    <form class="form-horizontal m-t-20" method="post" id="loginform" action="test_user.php">
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-info" id="to-recover" type="button">Register</button>
    ...
    $('#to-recover').on("click", function() {
        location.href = "authentication-register.php";
    });
    </script>
